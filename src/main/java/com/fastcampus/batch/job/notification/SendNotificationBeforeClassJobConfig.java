...
import com.fastcampus.batch.repository.notification.NotificationEvent;
import com.fastcampus.batch.repository.notification.NotificationModelMapper;
...
public class SendNotificationBeforeClassJobConfig {
    ...
    public Job sendNotificationBeforeClassJob(){
        return this.jobBuilderFactory.get("sendNotificationBeforeClassJob")
                .start(addNotificationStep()) // step 1
                .next(sendNotificationStep()) // step 2
                .build();
    }
