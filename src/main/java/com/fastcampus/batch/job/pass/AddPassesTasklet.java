package com.fastcampus.batch.job.pass;

import com.fastcampus.batch.repository.pass.*;
...
public class AddPassesTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
        ...
        //Ready 이고, 조건 시간에 맞는 Bulk Pass들을 가져온다.
        ...
        int count = 0;
        //벌크패스 List를 순회하며 user group에 속한 userId를 조회하고 해당 userId로 이용권 추가
